...
export const eras: TimelineEra[] = [
  {
    ...
    highlights: [
      "Interned at SAS in Cary my junior and senior years, doing tech support and some light coding.",
    ],
  },
  {
    id: "captech",
  ...
  },
  {
    ...
    years: "2022–2025",
    summary:
      "Led a team of three other frontend developers building security tooling. I also gave internal talks on frontend and mentored the developers around me.",
    projects: [
      {
  ...
  },
  {
    ...
    years: "2025–Now",
    summary:
      "IoT and RFID work for retail at scale, mostly quick proofs of concept that still have to pass a normal production review. I'm the one who brought agentic tooling to the team, and it took our vulnerability fixes from 2–3 days to 1–2 hours.",
    projects: [
      {
        id: "rfid-poc",
      ...
      },
      {
        ...
        summary:
          "Sole UI developer modernizing a mainframe cycle-count workflow. I ran a half-day war room with business stakeholders to make sure we gave users something better than what they had before, not just a copy/paste rewrite, and the early demos got good feedback from the Senior PM and VP.",
